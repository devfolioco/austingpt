...
export function NoAgentNotification(props: NoAgentNotificationProps) {
  ...
  return (
    <>
      {showNotification ? (
        <div className="fixed text-sm left-1/2 max-w-[90vw] -translate-x-1/2 flex top-6 items-center gap-4 bg-white border border-[#E4EAEB] text-[#171D21] px-4 py-3 rounded-lg shadow-md">
          <div>
          ...
          <p className="text-pretty w-max text-[#5C686D]">
